...
public class LadderScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError("LadderScript requires a Collider2D component!");
        }
        ...
        {
            Debug.LogWarning($"LadderScript on {gameObject.name} needs at least 2 waypoints to function properly!");
        }
    }
